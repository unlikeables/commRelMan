...
module.exports = {
  ...
  path_me_convs_limit: 'me/conversations?fields=id,updated_time,participants,message_count,link,messages.limit(100){id,from,to,message,attachments,created_time}&limit=100',
  path_conv_messages: '?fields=link,updated_time,messages.limit(10){id,from,to,message,attachments,created_time}',
