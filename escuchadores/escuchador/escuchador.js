...
function get_followAccounts_array(thedata, callback) {
...
function get_trackAccounts_array(thedata, callback) {
...
getFirstArrays(configCuentas, function(losdatos) {
    get_followAccounts_array(losdatos, function(losfollows){
	get_trackAccounts_array(losfollows, function(lostracks){
