...
var jsonString = JSON.stringify(strings);    
...
jsonString = replaceAll('","',"','",jsonString); 
            ...
            return '    gettextCatalog.setStrings(\'' + locale + '\', ' + jsonString  + ');\n';
            //agrego un replace para cambiar las commillas sencillas a dobles
            //return '    gettextCatalog.setStrings(\'' + locale + '\', ' + JSON.stringify(strings).replace(/'/g, "\\'") + ');\n';
        },
