    ...
    catalog = {
        ...
        loadRemote: function (url) {
            return $http({
                method: 'GET',
                //url: url,
                //ESTA LÍNEA SE PUSO PARA JALAR LAS TRADUCCIONES DE UNA RUTA PÚBLICA, LA RUTA SE DEFINE EN EL GRUNTFILE
                url:'public/modules/core/translates/translations.js',
                cache: catalog.cache
